...
export class ThreeJSController extends Component {
  ...
  planet_: THREE.Mesh<THREE.SphereGeometry, THREE.ShaderMaterial, THREE.Object3DEventMap>;
  sky_: THREE.Mesh<THREE.SphereGeometry, THREE.ShaderMaterial, THREE.Object3DEventMap>;
  ...
  LoadPlanet_() {
    const planetGeo = new THREE.SphereGeometry(5000, 48, 48);
    ...
    planet.position.set(10000, -1000, 0);
    this.planet_ = planet;
    this.scene_.add(planet);
  }
